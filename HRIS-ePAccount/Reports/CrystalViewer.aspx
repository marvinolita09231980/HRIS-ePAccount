<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrystalViewer.aspx.cs" Inherits="HRIS_ePAccount.Reports.CrystalViewer" %>
            ...
            <div class="col-12">
                <div id="crvHolder" style="overflow:scroll; width:100%;">
                    <CR:CrystalReportViewer 
                           ...
                           HasToggleParameterPanelButton="False" HasZoomFactorList="True" BorderStyle="None" DisplayPage="True" />
                </div>
            </div>
        </div>
    </form>
