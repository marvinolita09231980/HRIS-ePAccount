...
ng_HRD_App.controller("cNonEmployeeTaxRate_ctrlr", function ($scope, $compile, $http, $filter) {
    ...
    var init_table_data = function (par_data) {
        ...
        s.oTable = $('#datalist_grid_jo').dataTable(
            {
                ...
                columns: [
...

                    {
                        ...
                        "mRender": function (data, type, full, row) {
                            ...
                            return '<center>'
                                + '<div class="btn-group tooltip-demo" ng-show="' + NotAddedInSelectedYear(full["tax_year"])+'">'
                                ...
                                + '<div ng-hide="' + NotAddedInSelectedYear(full["tax_year"]) + '">'
    ...
    var init_table_data_rc = function (par_data) {
        ...
        s.oTable = $('#datalist_grid_rc').dataTable(
            {
    ...
    s.btn_save = function () {
        ...
        if (isdataValidated()) {
            ...
            h.post("../cNonEmployeeTaxRate/CheckData",
                {
                      par_payroll_year: $("#ddl_year option:selected").val()
