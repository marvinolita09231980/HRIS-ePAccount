ng_HRD_App.controller("cCashAdvDTL_ctrlr", function ($scope, $compile, $http, $filter) {
    var s               = $scope
    var h               = $http
    s.year              = []
    s.reports           = null;
    ...
    function init()
    {
        ...
        h.post("../cCashAdvDTL/InitializeData", { par_empType: s.employeeddl }).then(function (d) {
    ...
    s.SelectMonth = function (par_year, par_month, par_empType, par_remittancetype) {
        $("#loading_data").modal({ keyboard: false, backdrop: "static" })
        h.post("../cCashAdvDTL/RetrieveListGrid",
            {
                par_year: par_year
                , par_month: par_month
    ...
    s.SelectEmploymentType = function (empType)
    {
        ...
        h.post("../cCashAdvDTL/SelectEmploymentType", { par_empType: empType }).then(function (d)
            {
    ...
    s.btn_add = function () {
        ...
        else
        {
                ...
                h.post("../cCashAdvDTL/RetrieveVoucher", {
                        par_year                : s.ddl_year
                    , par_month                 : s.ddl_month
    ...
    s.btn_save_add = function (move_val) 
    {
        ...
        else
        {
            if (isdataValidated())
            {
                ...
                h.post("../cCashAdvDTL/SaveFromDatabase",
                    {
    ...
    s.btn_save_update = function ()
    {
        var row_id = $('#btn_save_update').attr('ngx-data');
            ...
            h.post("../cCashAdvDTL/UpdateFromDatabase", {
    ...
    s.btn_del_row = function (id_ss) {
        ...
        swal({
            ...
            .then(function (willDelete) {
                if (willDelete) {
                    h.post("../cCashAdvDTL/DeleteFromDatabase",
                        {
