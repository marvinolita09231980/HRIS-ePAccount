...
namespace HRIS_ePAccount.Models
{
    ...
    public partial class sp_monthly_remittance_gsis_rep_Result
    {
        ...
        public Nullable<decimal> payroll_amount_sif { get; set; }
        public Nullable<decimal> payroll_amount_loans { get; set; }
