...
namespace HRIS_ePAccount.Models
{
    ...
    public partial class sp_payrollregistry_salary_jo_rep_Result
    {
        ...
        public decimal nbr_days_absent { get; set; }
        public string payroll_registry_descr { get; set; }
        public Nullable<decimal> hours_ot { get; set; }
        public Nullable<decimal> hours_ot_010 { get; set; }
        public Nullable<decimal> hours_sal { get; set; }
        public Nullable<decimal> hours_sal_010 { get; set; }
        public Nullable<decimal> nbr_days_absent_010 { get; set; }
