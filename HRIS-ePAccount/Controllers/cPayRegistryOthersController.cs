...
{
    public class cPayRegistryOthersController : Controller
    {
        ...
        public ActionResult InitializeData(string par_empType)
        {
            ...
            var sp_payrollregistryaccounting_dtl_oth_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_oth_tbl_list(ddl_year, ddl_registry_nbr).ToList();
            ...
            return JSON(new { empType, payroll_template, userid, ddl_year, ddl_month, ddl_emp_type, ddl_template, ddl_group, sp_payrollregistryaccounting_dtl_oth_tbl_list, payrolltype }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult SelectPayrollGroup(string par_ddl_group, string par_registry_nbr)
        {
            try
            {
                ...
                return Json(new { sp_payrollregistryaccounting_dtl_oth_tbl_list }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        //*********************************************************************//
        public ActionResult EmployeeDetails(string par_empl_id)
        {
            try
            {
                string[] PreviousValuesonPage_cPayRegistry = Session["PreviousValuesonPage_cPayRegistry"].ToString().Split(new char[] { ',' });
                ...
                return Json(new {ddl_template}, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
                return Json(ex.Message, JsonRequestBehavior.AllowGet);
