...
{
    public class cPayRegistryJOController : Controller
    {
        ...
        public ActionResult initializeData(string par_empType)
        {
            ...
            var sp_payrollregistryaccounting_dtl_jo_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_jo_tbl_list(ddl_year, ddl_month, ddl_registry_nbr, ddl_template, ddl_group).ToList();
            ...
            return Json(new { empType, userid, ddl_year, ddl_month, ddl_emp_type, ddl_template, ddl_group, payroll_template, payrolltype, sp_payrollregistryaccounting_dtl_jo_tbl_list }, JsonRequestBehavior.AllowGet);
        ...
        public ActionResult SelectPayrollGroup(string par_ddl_group, string par_registry_nbr)
        {
            try
            {
                ...
                var sp_payrollregistryaccounting_dtl_jo_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_jo_tbl_list(ddl_year, ddl_month, ddl_registry_nbr, ddl_template, par_ddl_group).ToList();

                return Json(new { sp_payrollregistryaccounting_dtl_jo_tbl_list }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
