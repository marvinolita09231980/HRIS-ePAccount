...
// PURPOSE          :   Code Behind for Show Payroll Hazard/Subs/Laundry
//**********************************************************************************
// REVISION HISTORY
//**********************************************************************************
// AUTHOR                    DATE            PURPOSE
...
{
    public class cPayHazardSubsistenceLaundryController : Controller
    {
        ...
        public ActionResult initializeData(string par_empType)
        {
            ...
            var sp_payrollregistryaccounting_dtl_subs_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_subs_tbl_list(ddl_year, ddl_month, ddl_registry_nbr, ddl_template, ddl_group, ddl_emp_type).ToList();
            ...
            return Json(new { empType, payroll_template, userid, ddl_year, ddl_month, ddl_emp_type, ddl_template, sp_payrollregistryaccounting_dtl_subs_tbl_list, payrolltype }, JsonRequestBehavior.AllowGet);
        }
        ...
        //        var sp_payrollregistryaccounting_dtl_subs_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_subs_tbl_list(ddl_year, ddl_month, ddl_registry_nbr, ddl_template, par_ddl_group, ddl_emp_type).ToList();

        //        return Json(new { sp_payrollregistryaccounting_dtl_subs_tbl_list }, JsonRequestBehavior.AllowGet);
        //    }
        //    catch (Exception ex)
        //    {
