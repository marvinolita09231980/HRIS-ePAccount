...
{
    public class cPayVoucherController : Controller
    {
        ...
        public ActionResult InitializeData(string par_empType)
        {
            ...
            var sp_voucheraccounting_tbl_list = db_pacco.sp_voucheraccounting_tbl_list(ddl_year, ddl_month, ddl_template, ddl_emp_type, ddl_department).ToList();
            ...
            return Json(new { empType, payroll_template, userid, ddl_year, ddl_month, ddl_emp_type, ddl_template, sp_voucheraccounting_tbl_list, payrolltype, department_list, sub_department_list, division_list, section_list }, JsonRequestBehavior.AllowGet);
        }
