...
// PURPOSE          :   Code Behind for Show Payroll Salary Casual
//**********************************************************************************
// REVISION HISTORY
//**********************************************************************************
// AUTHOR                    DATE            PURPOSE
...
{
    public class cPayRegistrySalaryCasualController : Controller
    {
        ...
        public ActionResult InitializeData(string par_empType)
        {
            ...
            var sp_payrollregistryaccounting_dtl_ce_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_ce_tbl_list(ddl_year, ddl_month, ddl_registry_nbr, ddl_template, ddl_group).ToList();
            ...
            return Json(new { empType, payroll_template, userid, ddl_year, ddl_month, ddl_emp_type, ddl_template, sp_payrollregistryaccounting_dtl_ce_tbl_list, payrolltype, department_list, sub_department_list, division_list, section_list }, JsonRequestBehavior.AllowGet);
        }
        ...
        //        var sp_payrollregistryaccounting_dtl_ce_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_ce_tbl_list(ddl_year, ddl_month, ddl_registry_nbr, ddl_template, par_ddl_group, ddl_emp_type).ToList();

        //        return Json(new { sp_payrollregistryaccounting_dtl_ce_tbl_list }, JsonRequestBehavior.AllowGet);
        //    }
        //    catch (Exception ex)
        //    {
