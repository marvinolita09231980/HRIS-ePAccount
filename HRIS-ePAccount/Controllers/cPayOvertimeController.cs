...
{
    public class cPayOvertimeController : Controller
    {
        ...
        public ActionResult initializeData(string par_empType)
        {
            ...
            var sp_payrollregistryaccounting_dtl_ovtm_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_ovtm_tbl_list(ddl_year, ddl_month, ddl_registry_nbr, ddl_template, ddl_group).ToList();
            ...
            return Json(new { empType, payroll_template, userid, ddl_year, ddl_month, ddl_emp_type, ddl_template, ddl_group, sp_payrollregistryaccounting_dtl_ovtm_tbl_list, payrolltype }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult SelectPayrollGroup(string par_ddl_group, string par_registry_nbr)
        {
            try
            {
                ...
                var sp_payrollregistryaccounting_dtl_ovtm_tbl_list = db_pacco.sp_payrollregistryaccounting_dtl_ovtm_tbl_list(ddl_year, ddl_month, ddl_registry_nbr, ddl_template, par_ddl_group).ToList();

                return Json(new { sp_payrollregistryaccounting_dtl_ovtm_tbl_list }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
